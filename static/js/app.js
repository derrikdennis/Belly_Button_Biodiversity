  ...
  var data = [
    {
      ...
      gauge: {
        ...
        steps: [
          { range: [0, 1], color: "#ebffe2" },
          { range: [1, 2], color: "#c3ffa8" },
          { range: [2, 3], color: "#9aff6d" },
          { range: [3, 4], color: "#71ff32" },
          { range: [4, 5], color: "#4cf600" },
          { range: [5, 6], color: "#3aBB00" },
          { range: [6, 7], color: "#288000" },
          { range: [7, 8], color: "#154500" },
          { range: [8, 9], color: "#030b00" },
        ],
        threshold: {
